...
RUN conda install pytorch=1.10.0 cudatoolkit=11.3 torchvision -c pytorch
...
RUN pip install lpips==0.1.4 DateTime==4.4 matplotlib==3.5.1 boto3==1.21.13 omegaconf==2.0.0 pytorch-lightning==1.0.8 einops==0.4.1 torch-fidelity==0.3.0 wandb==0.12.11 opencv-python==4.5.5.64 timm==0.5.4 pandas==1.4.1
