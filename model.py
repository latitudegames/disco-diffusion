# -*- coding: utf-8 -*-
"""Disco Diffusion v3.1 [w/ SLIP & DangoCutn]

Adapted from an .ipynb that was Automatically generated by Colaboratory.
    ...
    def forward(self, input):
        ...
        if self.InnerCrop > 0:
            for i in range(self.InnerCrop):
                ...
                cutouts.append(cutout)
            if cutout_debug:
                TF.to_pil_image(cutouts[-1].add(1).div(2).clamp(0, 1).squeeze(0)
...
def do_run():
    ...
    def cond_fn(x, t, y=None):
            ...
            for model_stat in model_stats:
                for i in range(cutn_batches):
                    ...
                    cuts = MakeCutoutsDango(input_resolution,
                                            ...
                                            InnerCrop=cut_innercut[1000 -
                                                                   t_int], IC_Size_Pow=cut_ic_pow, IC_Grey_P=cut_icgray_p[1000-t_int]
                                            )
        ...
        if clamp_grad and x_is_NaN == False:
            ...
            # min=-0.02,
            return grad * magnitude.clamp(min=-clamp_max, max=clamp_max) / magnitude
        return grad
...
# Format: 40 cuts for the first 400 /1000 steps, then 20 for the last 600/1000
cut_overview = [35]*400+[5]*600
